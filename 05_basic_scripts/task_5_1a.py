...
device_par = input("Введите параметр: ")

# Выводим информацию о выбранном устройстве, используя имя устройства как ключ словаря
print(london_co[device_name][device_par])
