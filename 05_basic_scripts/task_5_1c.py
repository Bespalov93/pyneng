...
# Запрашиваем у пользователя ввод имени устройства
device_name = input("Введите имя устройства: ")

# Получаем список возможных параметров из словаря для указанного устройства
params = ', '.join(london_co[device_name].keys())

# Запрашиваем у пользователя ввод параметра, отображая список возможных параметров
param_name = input(f"Введите имя параметра ({params}): ")

# Пытаемся получить значение параметра с выводом сообщения, если параметр отсутствует
print(london_co[device_name].get(param_name, "Такого параметра нет"))
